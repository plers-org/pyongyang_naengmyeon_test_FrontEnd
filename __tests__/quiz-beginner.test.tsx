...
const mockQuestions = [
  {
    question_id: 1,
    question_text: "좋아하는 국물의 첫 느낌은?",
    choices: [
      { choice_id: 1, choice_text: "깊고 진한 고기 맛과 향이 느껴져야" },
      { choice_id: 2, choice_text: "슴슴한데 은은한 감칠맛이 있어야" },
    ],
    progress: 50,
  },
  {
...
describe("입문자 문항 플로우", () => {
  ...
  it("옵션을 선택하면 다음 버튼이 활성화된다", async () => {
    ...
    await user.click(
      screen.getByRole("button", { name: "깊고 진한 고기 맛과 향이 느껴져야" }),
    );
